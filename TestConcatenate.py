...
x1_train, x1_test, y1_train, y1_test = train_test_split(x1, y, random_state=66, test_size=0.4, shuffle=False)
...
dense_2 = Dense(30)(dense1)
dense_3 = Dense(7)(dense1_2)
...
mse = model.evaluate([xl_test, x2_test], y_test, batch_size=1)

...
dense1_1 = Dense(50, activation = 'relu',name = 'dense1_1')(input1)
dense1_2 = Dense(50, activation = 'relu',name = 'dense1_2')(dense1_1)
dense1_3 = Dense(50, activation = 'relu',name = 'dense1_3')(dense1_2)
dense1_4 = Dense(50, activation = 'relu',name = 'dense1_4')(dense1_3)
dense1_5 = Dense(30, activation = 'relu',name = 'dense1_5')(dense1_4)

output3 = Dense(30) (dense1_5)
output3_2 = Dense(100)(output3)
output3_3 = Dense(50)(output3_2)
output3_4 = Dense(50)(output3_3)
